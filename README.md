...
This script pulls all of it's resources from the proper Github repositories in order to make sure you are up-to-date. 
The only dependencies it does not get by itself are the required Python modules

## Acknoledgements:
Disclaimer: Includes Acknowledgements from the above linked repo from UberGuidoz
